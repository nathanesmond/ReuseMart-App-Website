...
import { DeleteOrganisasi } from "../../../api/ApiAdmin";
import { toast } from "react-toastify";

interface ModalDeleteOrganisasiProps {
	onClose: () => void;
	idOrganisasi: number;
	show: boolean;
    onSuccessDelete: () => void;
}
const ModalDeleteOrganisasi = ({
	onClose,
	idOrganisasi,
	show,
    onSuccessDelete
}: ModalDeleteOrganisasiProps) => {
	const handleClose = () => {
		onClose();
	};
...
export default ModalDeleteOrganisasi;
